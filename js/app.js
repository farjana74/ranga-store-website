...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src=${image}></img>
      ...
      <h4 class="fs-6"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="far fa-star"></i>: ${product.rating.rate}</h4>
      <h4 class="fs-6">Rating person: ${product.rating.count}</h4>
      <h4 class="fs-5">Price: $ ${product.price}</h4>
